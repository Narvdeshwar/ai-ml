...
## 5.7 `list` vs `numpy` by using the copy function
...
# 6: Common data type
`dont` use string or object to store the data since numpy is designed to perform the computational operation
